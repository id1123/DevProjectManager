...
function ProjectCard({ project, definitions, installations, onOpen, onLaunch, onAddModule, onEditModule, onEdit, onDelete }: { project: Project; definitions: IdeDefinition[]; installations: DashboardData["ideInstallations"]; onOpen: () => void; onLaunch: (module: ProjectModule) => void; onAddModule: () => void; onEditModule: (module: ProjectModule) => void; onEdit: () => void; onDelete: () => void }) {
  return <article className="project-card">
    ...
    <div className="card-module-list">{project.modules.map((module) => {
    ...
    })}<button className="card-add-module" title="添加项目" onClick={onAddModule}><Plus size={24} /><span>添加项目</span></button></div>
